    ...
    <section class="bg-linear-to-br from-white via-light to-white overflow-hidden border-b border-gray-100/50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <img
              src="https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?q=80&w=1470&auto=format&fit=crop"
              alt="核医学场所建设"
              class="w-full h-full object-cover hover:scale-102 transition duration-700"
              loading="eager"
            >
          </div>
        </div>
    ...
    <section class="py-20 lg:py-24 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          tag="服务总览"
          title="三大专业篇章 · 全流程覆盖"
          description="设计、施工、设备三大篇章，构建核医学场所建设完整服务体系。"
        />
    ...
    <section class="py-20 lg:py-24 bg-light">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          tag="专业优势"
          title="为什么选择贝瑞医疗"
          description="从行业标准制定到数字孪生赋能，打造核医学场所建设核心壁垒。"
        />

        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            v-for="(adv, index) in coreAdvantages"
            :key="index"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <SectionHeader
            tag="实绩见证"
            title="典型案例展示"
            description="已为全国30+医疗机构提供核医学场所建设服务，覆盖三甲医院及专科机构。"
            align="left"
            class="mb-0!"
          />
          <NuxtLink
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <SectionHeader
            tag="资讯前沿"
            title="新闻与行业资讯"
            description="了解贝瑞医疗最新动态、核医学场所建设行业资讯与技术分享。"
            align="left"
            class="mb-0!"
          />
          <NuxtLink
