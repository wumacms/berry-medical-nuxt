...
<template>
  <div>
    <!-- 首屏 Hero -->
    <PageHero
      tag="PERFORMANCE INTRODUCTION"
      tag-icon="fa-solid fa-briefcase"
      title="30+项目实绩"
      highlight="见证专业实力"
    ...
    <section id="cases" class="py-20 lg:py-28 bg-white scroll-mt-24">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          tag="典型案例"
          title="精选标杆项目成果展示"
          description="涵盖三甲医院核医学科新建、放射性药物制药净化场所、旧院有限空间改造等多类型标杆工程。"
        />
        ...
        <div class="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mb-12">
          <button
            ...
            :key="cat.key"
            type="button"
            class="px-5 py-2 rounded-full text-xs font-semibold transition-all duration-300 cursor-pointer"
            :class="[
    ...
    <section class="py-20 lg:py-28 bg-light">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          tag="服务客户"
          title="覆盖多元医疗与科研机构"
          description="从三甲医院到专科医院，从科研院所到行业药企，为各类客户定制专属合规场所方案。"
        />
    ...
    <section class="py-20 lg:py-28 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          tag="客户评价"
          title="行业信赖之选"
          description="以严谨求实的作风和卓越的工程交付质量，赢得合作单位高度赞誉。"
        />
    ...
    <!-- 底部行动呼吁 -->
    <CtaBanner
      title="了解与您医院类似的标杆项目经验"
      subtitle="联系贝瑞医疗，为您匹配专属医疗机构类型的前期调研案例与造价参考。"
    />
  </div>
</template>
