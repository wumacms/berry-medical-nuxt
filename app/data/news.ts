...
export const newsList: NewsItem[] = [
  {
    ...
    author: "贝瑞医疗编辑部",
    readCount: 1250,
    summary: "近日，贝瑞医疗与华中地区某三甲医院正式签约，将为其核医学科提供从选址规划、辐射防护施工到环评验收的全生命周期一站式服务。项目预计工期6个月，建成后将显著提升该院核医学诊疗能力。",
  ...
  },
  {
    ...
    author: "数字化研发部",
    readCount: 980,
    summary: "新版本新增设备预测性维护与辐射剂量智能预警模块，进一步提升核医学科智能化管理水平。",
  ...
  },
  {
    ...
    author: "法规咨询组",
    readCount: 1420,
    summary: "结合最新药监政策，梳理放射性药物制备净化场所的验收标准与常见问题，助力高效通过审批。",
  ...
  },
  {
    ...
    author: "工程部",
    readCount: 860,
    summary: "贝瑞医疗凭借创新布局方案，在不足300㎡空间内完成核医学科整体改造，一次性通过环评及卫评验收。",
  ...
  },
  {
    ...
    author: "政策研究室",
    readCount: 1680,
    summary: "针对最新发布的核技术应用项目环评要求，分析对核医学场所建设的影响及合规建议。",
  ...
  },
  {
    ...
    author: "设备支持组",
    readCount: 1100,
    summary: "从防护性能、洁净等级到操作便捷性，全面对比分析合成热室与分装热室的选型要点。",
    imageUrl: "https://images.unsplash.com/photo-1581092160562-40aa08e78837?q=80&w=1470&auto=format&fit=crop",
    tags: ["设备选型", "热室", "手套箱"],
    content: `
